...
{{< onboarding/ext-nav-card
  ...
  description="Få hjelp i rollen som fadder og faglig mentor"
...
{{< onboarding/ext-nav-card
  ...
  description="Få hjelp til å kickstarte karrieren din hos oss."
...
{{< onboarding/ext-nav-card
  ...
  description="Sett deg inn i regler, rutiner og retningslinjer for arbeidsforholdet ditt."
...
{{< onboarding/ext-nav-card
  ...
  description="Kontakt IT drift i teams"
